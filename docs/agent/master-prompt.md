...
**Put this in:** `docs/agent/master-prompt.md`.

Don't add more to it right now. The project-specific details belong in your other documents; this file should remain the **agent's operating rules**. Your uploaded methodology makes the same distinction between persistent agent instructions and the phase/task-specific instructions used during implementation. 
```
